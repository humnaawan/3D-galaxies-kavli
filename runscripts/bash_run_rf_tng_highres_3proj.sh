...
rdecider=50
# ------------------------------------------------------------------------------
features_path=${base_dir}'tng-100_z0.4_3proj_shape'${rdecider}'_features/'
base_outdir=${base_dir}'tng-100_z0.4_shape'${rdecider}'_rf_3proj_'
